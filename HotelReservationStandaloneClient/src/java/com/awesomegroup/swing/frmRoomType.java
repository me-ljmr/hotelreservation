...
public class frmRoomType extends javax.swing.JFrame {
    ...
    private void showSelected(int row){
        ...
        selId = Integer.parseInt(this.tblRateTypeList.getValueAt(row, 0).toString());
         txtDescription.setText(this.tblRateTypeList.getValueAt(row, 1).toString());
       spRate.setValue(Double.parseDouble(this.tblRateTypeList.getValueAt(row, 2).toString()));
    }
    /**
