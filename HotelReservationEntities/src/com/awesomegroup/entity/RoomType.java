...
@NamedQueries({
    ...
    , @NamedQuery(name = "RoomType.findByTitle", query = "SELECT r FROM RoomType r WHERE r.title = :title")
    ,@NamedQuery(name = "RoomType.count", query = "SELECT count(r) FROM RoomType r")
...
public class RoomType implements Serializable {
    ...
    public RoomType(Integer id, String title) {
        this.id = id;
        this.title = title;
    }
    ...
    public String toString() {
        return "com.awesomegroup.entity.RoomType[ id=" + id + " ]";
    }
